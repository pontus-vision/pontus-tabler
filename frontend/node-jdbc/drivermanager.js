...
var driverManager = {
    ...
    getConnection: function (url, propsoruser, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                args = [url, propsoruser, password].filter(function (arg) { return arg !== undefined; });
                validArgs = args[0] &&
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        resolve(java.callStaticMethodSync.apply(java, __spreadArray([DM, "getConnection"], args, true)));
                    })];
            });
        });
    },
    getConnectionSync: function (url, propsoruser, password) {
        var args = [url, propsoruser, password].filter(function (arg) { return arg !== undefined; });
    ...
    setLoginTimeout: function (seconds) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        java.callStaticMethodSync(DM, "setLoginTimeout", seconds);
                    })];
            });
        });
    }
