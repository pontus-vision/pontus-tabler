...
const CreateNewTable = () => {
  ...
  <div className="create-new-table">
          ...
          <table className="create-new-table-table">
            <thead>
              <tr className="create-new-table-table-header">
                ...
                <th className="create-new-table-table-header-cell">Actions</th>
              </tr>
            </thead>
            <tbody className="create-new-table-table-body">
              {cols.map((col, index) => (
                <NewTableCol key={col.colId} setCols={setCols} index={index} />
              ))}
            </tbody>
          </table>
          <button
    ...
    <button onClick={() => create()} className="create-new-table-create-button">
      Create
